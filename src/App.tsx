  ...
  return (
    <div className="flex items-center gap-8 sm:gap-12 whitespace-nowrap">
      <a
        ...
        className="inline-flex items-center gap-2 text-sm sm:text-base font-medium text-white transition-opacity hover:opacity-80"
      >
        <PhoneIcon />
...
function ContactTicker() {
  return (
    ...
    >
      {/* Soft edge fades */}
      <div className="pointer-events-none absolute left-0 top-0 z-10 h-full w-8 sm:w-16 bg-gradient-to-r from-[#78ADD0] to-transparent" />

      <div className="pointer-events-none absolute right-0 top-0 z-10 h-full w-8 sm:w-16 bg-gradient-to-l from-[#78ADD0] to-transparent" />
